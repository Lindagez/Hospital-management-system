            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto" style="margin-right: 70px;">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="">Add laboratorist</a>
                            <a class="dropdown-item" href="adminLabList.jsp">View laboratorist</a>
                        </div>
                    </li>
                </ul>
            </div>
        ...
        <div class="row mb-3">
            ...
            <%
                try {
                    con = DatabaseConnection.initializeDatabase();
                    Statement st = (Statement) con.createStatement();
                    String query = "select count(*) from labratory";
                    ResultSet rs = st.executeQuery(query);
                    while (rs.next()) {
            ...
            <div class="col-xl-3 col-lg-6" style="margin-top: 20px;">
                <div class="card card-inverse card-warning">
                    <div class="card-block bg-warning">
                        ...
                        <h6 class="text-uppercase"  style="text-align: center"><a href="adminLabList.jsp">Laboratorist</a></h6>
