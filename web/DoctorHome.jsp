                            ...
                            <table>
                                <thead>
                                    <tr class="row100 head">
                                        ...
                                        <th class="cell100 column8">Report</th>
                            ...
                            <table>
                                <tbody>
                                    <tr class="row100 body">
                                        ...
                                        <td class="cell100 column8"><%=rs.getString(11)%></td>
                                        
                                                                         
                                         <td class="cell100 column9">
                                            <a href="editpatient.jsp?mob=<%=mob%>">Edit  </a>
                                            <a href="laboratorist.jsp?mob=<%=mob%>">   Send</a>
