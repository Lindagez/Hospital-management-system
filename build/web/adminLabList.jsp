            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto" style="margin-right: 70px;">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="addWorker.jsp">Add laboratory</a>
                            <a class="dropdown-item" href="adminLabList.jsp">View laboratory</a>
                        </div>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="table100 ver3 m-b-110">
                            ...
                            <table>
                                <thead>
                                    <tr class="row100 head">
                                        ...
                                        <th class="cell100 column6">Mobile</th>
                        ...
                        <%
                            try {
                                ...
                                if (query != null) {
                                    sql = "select * from labratory where fname like '%" + query + "%' or lname like '%" + query + "%' ";
                                } else {
                                    sql = "select * from labratory";
                                }
