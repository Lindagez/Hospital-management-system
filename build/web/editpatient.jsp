    ...
    <body>
        ...
        <div class="container-contact100">
            ...
            <div class="wrap-contact100">
                ...
                <form class="contact100-form validate-form"  action="<%=request.getContextPath()%>/upppp" method="post">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="statusis required">
                        ...
                        <input class="input100" type="text"value="<%= rs.getString(9)%>" name="status" placeholder="Enter Age">
                        <span class="focus-input100"></span>
                    </div>
                 <div class="wrap-input100 validate-input" data-validate="statusis required">
                        <span class="label-input100">description:</span>
                        <input class="input100" type="text" value="<%= rs.getString(10)%>"name="description" placeholder="Enter description">
                        <span class="focus-input100"></span>
                    </div>
