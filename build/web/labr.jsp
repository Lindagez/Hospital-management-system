...
<html>
    ...
    <body>
        ...
        <div class="serchbar">
            <form action="labr.jsp" method="post">
                            ...
                            <table>
                                <thead>
                                    <tr class="row100 head">
                                        ...
                                        <th class="cell100 column6">Report</th>
                            ...
                            <table>
                                <tbody>
                                    <tr class="row100 body">
                                        ...
                                        <td class="cell100 column6"><%=rs.getString(10)%></td>
                                        <td class="cell100 column7"><%=rs.getString(11)%></td>
                                       
                                       
                                         <td class="cell100 column8">
                                            <a href="review.jsp?mob=<%=mob%>">Edit  </a>
                                            <a href="DoctorLogin.jsp?mob=<%=mob%>">  Send</a>
