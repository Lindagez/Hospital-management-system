            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto" style="margin-right: 70px;">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="addWorker.jsp">Add laboratorist</a>
            ...
            <div class="wrap-contact100">
                <div class="contact100-form-title" style="background-image: url(img/bg-01.jpg);">
                    <span class="contact100-form-title-1">
                        Laboratorist Registration Form
                    </span>				
                </div>
                ...
                <form class="contact100-form validate-form"  action="<%=request.getContextPath()%>/AddWorker" method="post">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="password is required">
                        ...
                        <input class="input100" type="text" name="address" placeholder="Enter Adress">
                        <span class="focus-input100"></span>
                    </div>
